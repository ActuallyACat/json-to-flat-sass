...
exports.jsonToFlatSass = function (_a) {
    var source = _a.source, destination = _a.destination, separator = _a.separator;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _b = _c.sent(), err = _b[0], fileData = _b[1];
                    if (!fileData) {
                    ...
                    flattenedInput = exports.flattenInputToString(parsedString, separator);
